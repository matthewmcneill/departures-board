...
## Completed
- [x] startup screens don't show and then the board display seems very static and is not laid out properly. need to work through this. Probably starting with the startup screens and then working through the system screens. (Queued in sessions 6cb48930, 9c4faedc, and active in cf3f6db7) (Fixed by unified boot progress bar and hash-based UI reconciliation)
