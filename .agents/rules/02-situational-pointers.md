...
- **Hardware Interaction**: If you need to build, compile, flash, check logs, or handle queues for PlatformIO, you MUST load `.agents/skills/pio-manager/SKILL.md` exclusively, and prefer the use of the mcp server.
